...
export default function Catalog() {
  ...
  let items = [
    { title: "Cool mug", imgUrl: "/assets/img1.png", price: 12 },
    { title: "Second item", imgUrl: "/assets/img1.png", price: 25 },
    { title: "Third item", imgUrl: "/assets/img1.png", price: 30 },
    { title: "Fourth item", imgUrl: "/assets/img1.png", price: 40 },
  ];

  let itemsList = items.map((v, idx) => (
    <li
      key={idx}
      className="p-3 shadow rounded-2xl mt-2 flex items-center space-x-5 cursor-pointer hover:bg-gray-100"
      onClick={() => setSelectedItem(v)}
    >
      <img src={v.imgUrl} className="max-w-10 max-h-10 flex-1" alt={v.title} />
          ...
          <div className="bg-white p-6 rounded-xl shadow-xl text-center">
            ...
            <div className="space-x-4">
              ...
              <button
                ...
                onClick={() => alert(`Redeemed ${selectedItem.title}`)}
              >
                Redeem
              </button>
            </div>
